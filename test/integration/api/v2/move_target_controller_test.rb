...
test "show query count stays within budget" do
  ...
  test "list supports conditional get with etag" do
    get "/api/v2/move-target", params: { limit: 2, offset: 0 }
    assert_response :success
    ...
    get "/api/v2/move-target", params: { limit: 2, offset: 0 }, headers: { "If-None-Match" => etag }
  ...
  test "show supports conditional get with etag" do
    ...
    get "/api/v2/move-target/#{target.id}", headers: { "If-None-Match" => etag }
    assert_response :not_modified
    assert_observability_headers
    assert_equal "", response.body
  end
